...
/**
 * A wrapped {@link ForgeConfigSpec} for the only reason of hooking into {@link #correct(UnmodifiableConfig, CommentedConfig, LinkedList, List, ConfigSpec.CorrectionListener, ConfigSpec.CorrectionListener, boolean)},
 ...
 */
public class ConfigSpecWrapper extends ForgeConfigSpec {
    ...
    public ConfigSpecWrapper(ForgeConfigSpec config) {
        super(config, config.getValues(), Maps.newHashMap());
        this.levelComments = ObfuscationReflectionHelper.getPrivateValue(ForgeConfigSpec.class, this, "levelComments");
    }
    ...
    @Override
    public void setConfig(CommentedConfig data) {
        // do not call ForgeConfigSpec#acceptConfig as it triggers Forge's correction behavior
        ObfuscationReflectionHelper.setPrivateValue(ForgeConfigSpec.class, this.getSpec(), data, "childConfig");
